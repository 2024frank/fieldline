...
export const api = {
  ...
  createDevice: (body: { name: string; eui: string; typeId: string; joinEui?: string; appKey?: string }) => request<{ device: Device; appKey: string; keySource?: "provided" | "generated" }>("/devices", { method: "POST", body: JSON.stringify(body) }),
